...
=======================
* ✅ 测试分支 `test/no-driver-cam-fix` 从 commaai/openpilot `master@02b6cef` 更新至 `master@084747c`，同步 2026-07-28 至 2026-08-21 的 150 个上游提交
* ✅ 继续采用“先在 openpilot 合并并修复，再转入 DP 测试分支”的流程；本次建立了真正的双父 Git 合并节点，完整保留官方与 DP 两侧历史，后续可继续增量合并
...
* ⚠️ 官方 MetaDrive 用例因当前环境条件自动跳过；台架和实际道路测试尚未完成，因此本版本仍仅用于测试，不合入正式 `merge/comma-master`
